 ...
 * @param {boolean=} options.defaultModelOmitNew A boolean which specifies a
 * default value for the `omitNew` option to `model.toJSON(options)`. Specifying
...
module.exports = function(options) {
  ...
  if (
    options.hasOwnProperty('defaultModelOmitNew') &&
    (typeof options.defaultModelOmitNew !== 'boolean')
  ) {
    throw new SanityError('defaultModelOmitNew passed as plugin option must be a boolean.');
  }
  var defaultModelOmitNew = options.defaultModelOmitNew;
    ...
    var Model = Bookshelf.Model.extend({
      ...
      toJSON: function(options) {
        ...
        if (options.hasOwnProperty('omitNew')) {
          // No op.
        } else if (typeof defaultModelOmitNew === 'boolean') {
          options.omitNew = defaultModelOmitNew;
        } else {
          // No op.
        }
        ...
        if (options.omitNew && this.isNew()) {
          return BluebirdPromise.resolve(toJSON.call(this, options));
        }
          ...
          .then(function(role) {
            ...
            return contextSpecificVisiblePropertiesPromise.bind(this).then(function(contextSpecificVisibleProperties) {
              ...
              return ensureRelationsPromise.bind(this).then(function(ensuredRelations) {
                ...
                var jsonPromises = toJSON.call(this, options);
